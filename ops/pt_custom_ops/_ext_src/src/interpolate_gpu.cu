// modified based on https://github.com/erikwijmans/Pointnet2_PyTorch/blob/master/pointnet2_ops_lib/pointnet2_ops/_ext-src/src/interpolate_gpu.cu
...
__global__ void three_nn_kernel(int b, int n, int m,
  ...
  // each kernel consists of grids, each  grid consists of threads
  ...
  // iterate over each point on a thread with a block interval, note: the interval is stride for parallel computing
